...
client = MongoClient("mongodb+srv://youtubepy:youtubepy@youtube.5ytjh.mongodb.net/",tlsAllowInvalidCertificates = True)
#Not a good idea to include id and pass in code 
